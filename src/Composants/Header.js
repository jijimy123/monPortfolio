...
export const Header = () => {
  return (
    <>
      <div className="relative flex flex-col-reverse py-6 lg:flex-col font-body">
        ...
        <div className="relative flex flex-col items-start w-full max-w-xl px-4 py-9 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl z-10">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <div className="bg-blue-100 bg-opacity-50 border-4 border-teal-accent-100 rounded-xl mb-3 w-11/12">
            ...
            <div className="flex items-center">
              <Link
                className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-indigo-100 transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                to="/apropos"
              >
                En savoir plus 🧐
              </Link>
